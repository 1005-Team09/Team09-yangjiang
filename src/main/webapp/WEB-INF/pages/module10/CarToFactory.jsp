...
<table class="form-table">
    ...
    <tr class="trTitle" id="searchtr1">
        ...
        <td><input class="mini-textarea" allowInput="false" style="width:100%;height:30px;" value="" name=""/></td>
    ...
    <tr class="trTitle" id="searchtr2">
        ...
        <td class="td2">
            <input id="btnEditDep"
                   ...
                   name="facId" textName="facName"/>
        </td>
        <td class="title">厂房地点*</td>
        <td>
            <input id="btnEdit2" class="mini-buttonedit" allowInput="false" onbuttonclick="onButtonEdit" name="a" textName="b"
    ...
    <tr class="trTitle" id="searchtr3">
        ...
        <td class="td2"><input type="date" class="mini-datepicker" allowInput="false" required="true" style="width: 100%;height: 30px"/>
        </td>
...
<table class="form-table">
    ...
    <tr class="trTitle" id="searchtr7">
        ...
        <td class="td2" id="btnEditStaffTd">
            <input id="btnEditStaff"
                   ...
                   style="width:100%;" allowInput="false"
                   name="comId" textName="comName"/>
        </td>
        <td class="title">单位负责人*</td>
        <td>
            <input id="btnEdit4" class="mini-buttonedit" allowInput="false" onbuttonclick="onButtonEdit" name="a" textName="b"
                   style="width: 100%;height: 30px"/>
        </td>
    </tr>
    ...
    <tr id="searchtr9">
        <td colspan="5"><a class="mini-button" style="float: right" iconCls="submit" onclick="">提交</a></td>
    </tr>
</table>
        ...
        mini.open({
            ...
            ondestroy: function (action) {
                ...
                if (action == "ok") {
                    ...
                    if (data) {
                        btnEdit.setValue(data.comId);
                        btnEdit.setText(data.comName);
                    }
                }
            }
        });
        ...
        mini.open({
            ...
            ondestroy: function (action) {
                ...
                if (action == "ok") {
                    ...
                    data = mini.clone(data);
                    if (data) {
                        btnEdit.setValue(data.facId);
                        btnEdit.setText(data.facName);
                    }
                }
            }
        });
